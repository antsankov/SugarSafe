...
package com.example.android.wearable.sugarsafe;

import com.example.android.wearable.sugarsafe.fragments.CounterFragment;
import com.example.android.wearable.sugarsafe.fragments.SettingsFragment;
...
public class MainActivity extends Activity {
    ...
    private static final long SCREEN_ON_TIMEOUT_MS = 2000000000; // in milliseconds
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGlucoseCounter = Utils.getCounterFromPreference(this);
    ...
    public void resetCounter() {
        setCounter(Utils.getCounterFromPreference(this));
        renewTimer();
    }
